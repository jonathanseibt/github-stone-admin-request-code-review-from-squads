    ...
    whenHide('#reviewers-select-menu .select-menu-list svg.anim-rotate', (): void => {
      whenShow('#reviewers-select-menu > details-menu .select-menu-list', (element): void => {
        if (!get('#squad-platform-ux-button')) {
          element.innerHTML = buildReviewersButtonHtml('squad-platform-ux-button', 'Squad Platform & UX', 'Lucas, Paulinho, e Vini') + element.innerHTML;
        ...
        if (!get('#squad-banking-capital-button')) {
          element.innerHTML = buildReviewersButtonHtml('squad-banking-capital-button', 'Squad Banking & Capital', 'Hoffmann, Malê, Phelipe, Thiago, e Vini') + element.innerHTML;
        ...
        if (!get('#squad-risk-lifecycle-button')) {
          element.innerHTML = buildReviewersButtonHtml('squad-risk-lifecycle-button', 'Squad Risk & Lifecycle', 'Ermerson, Guh, e Matheus') + element.innerHTML;
        ...
        if (!get('#squad-payments-lifecycle-button')) {
          element.innerHTML = buildReviewersButtonHtml('squad-payments-lifecycle-button', 'Squad Payments & Lifecycle', 'Amandinha, Ka, Pitta, Seibt, e Sidney') + element.innerHTML;
